...
/* Credits used by the W-4 model. The child credit rose to $2,200 for 2026. */
export const CREDITS = {
  ...
  verified: {
    checkedOn: CHECKED,
    source: `${REV_PROC}; IRS Child Tax Credit and Credit for Other Dependents pages`,
    by: 'BAMU',
  } as Verified,
  source: REV_PROC,
} as const;

/* Self-employment tax. All four figures are statutory rather than indexed:
   the 92.35% net earnings rate, the 12.4% and 2.9% rates, and the 0.9%
   additional Medicare rate. Only the wage base they apply to moves. */
export const SE_TAX = {
  ...
  verified: {
    checkedOn: CHECKED,
    source: 'IRC §1401 and §1402(a)(12); IRS Schedule SE — statutory rates, not indexed',
    by: 'BAMU',
  } as Verified,
